...
const DOG_ROM st_ot st_object_types[] DOG_PROGMEM =
{
    /* 0: empty object type */
...
void st_Draw(void)
{
  switch(st_state)
  {
    ...
    case ST_STATE_IPREPARE:
      ...
      dog_SetHLine(dog_width-st_to_diff_cnt-10, dog_width-st_to_diff_cnt, (dog_width-6)/2-1);
      break;
    case ST_STATE_GAME:
      st_DrawInGame();
      break;
    ...
    case ST_STATE_IEND:
      ...
      dog_DrawStrP(0, (dog_width-6)/2, font_4x6, DOG_PSTR("Game Over"));
      dog_DrawStr(50, (dog_width-6)/2, font_4x6, dog_itoa(st_player_points));
      dog_DrawStr(75, (dog_width-6)/2, font_4x6, dog_itoa(st_highscore));
      dog_SetHLine(st_to_diff_cnt, st_to_diff_cnt+10, (dog_width-6)/2-1);
      break;
  }
}
