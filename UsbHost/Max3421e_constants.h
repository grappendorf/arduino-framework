...
// TODO: Check if the 2560 check should use `defined` too.
#if defined(__AVR_ATmega1280__) || defined(__AVR_ATmega1284P__) || (__AVR_ATmega2560__)
  #define SCK_PIN   52
  #define MISO_PIN  50
  #define MOSI_PIN  51
  ...
  #define SS_PIN    53
#endif
#elif defined(__AVR_ATmega168__) || defined(__AVR_ATmega328P__) || defined(__AVR_ATmega644P__) || defined(__AVR_ATmega32U4__)
  #define SCK_PIN   13
  #define MISO_PIN  12
  #define MOSI_PIN  11
  #define SS_PIN    10
